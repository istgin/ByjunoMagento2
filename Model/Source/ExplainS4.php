...
class ExplainS4 extends Field
{
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $message = 'S4 Transaction (Settlement/Invoice) must be delivered to CembraPay manually or from ERP system';
        $color = 'FFE5E6';
        if ($byjuno_s4_explain == 1) {
            $message = 'S4 Transaction (Settlement/Invoice) will be sent to CembraPay when new Invoice is created on the order';
            $color = 'ddffdf';
        }
