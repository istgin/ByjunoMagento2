...
class Edit extends \Magento\Backend\Block\Widget\Container
{
    ...
    protected function _toHtml()
    {
        try {
            ...
            $type = $logview->getData("type");
            if ($type == "Byjuno S4 (CembraCheckout)") {
                $request = $logview->getData("request");
                $requestPretty = json_encode(json_decode($request), JSON_PRETTY_PRINT);
                $response = $logview->getData("response");
                $html = '
                ...
                <table width="50%">
                    ...
                    <tr>
                        <td width="50%" style="border: 1px solid #CCCCCC; padding: 5px; vertical-align: top;"><code style="width: 100%; word-wrap: break-word; white-space: pre-wrap;">' . $requestPretty . '</code></td>
                        <td width="50%" style="border: 1px solid #CCCCCC; padding: 5px; vertical-align: top;"><code style="width: 100%; word-wrap: break-word; white-space: pre-wrap;">' . $response . '</code></td>
                    </tr>
                </table>';
            } else {
