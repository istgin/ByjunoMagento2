...
class IceHelper extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public $section = "byjunocore";
    public $serial_required = "0";
    public $imageDir = "adminhtml/default/default/byjuno/images/";
    ...
    {
        return $this->_storeManager->getStore()->getUrl("byjuno/processing/" . $action, array('_secure' => true));
    }
    ...
    {
        return Mage::app()->getStore($storeID)->getConfig(Byjuno_ByjunoCore_Model_Config::MERCHANTID);
    }

    public function getSecretcodeForStore($storeID)
    {
        return Mage::app()->getStore($storeID)->getConfig(Byjuno_ByjunoCore_Model_Config::SECRETCODE);
    }
    ...
    {
        return ($statement = $this->getConfig(Byjuno_ByjunoCore_Model_Config::TRANSDESCR)) ? $statement : $default;
    }
